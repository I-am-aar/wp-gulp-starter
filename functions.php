<?php
/**
 * Husavik Ol functions and definitions
 *
...
if ( ! function_exists( '_themename_setup' ) ) :
	...
	function _themename_setup() {
		 ...
		 * If you're building a theme based on Husavik Ol, use a find and replace
...
function _themename_scripts() {
	wp_enqueue_style( '_themename-init-styles', get_stylesheet_uri() );

	wp_enqueue_style( '_themename-main-styles', get_template_directory_uri() . '/dist/css/styles.css', array(), '1.0.0', 'all' );

  wp_enqueue_script( '_themename-scripts', get_template_directory_uri() . '/dist/js/scripts.js', array('jquery'), '1.0.0', true );
